...
def main():
    ...
    parser.add_argument('base_path', type=str, default='../configs/test/denoise.yaml', help='a string path to the test configuration file')
    parser.add_argument('--device', type=str, help='device to move the model and tensors to. Either cuda or cpu.', default='cpu')
    parser.add_argument('--overwrite', action='store_true', help='overwrite existing images rather than skipping the denoising process.')
